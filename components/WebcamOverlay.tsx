...
export default function WebcamOverlay() {
  ...
  return (
    <motion.div
      className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md h-64 bg-black border-2 border-red-500 rounded-lg overflow-hidden z-50"
